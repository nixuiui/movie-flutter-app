...
List<AutoCompletePrediction> autoCompletePredictionFromJson(String str) =>
    List<AutoCompletePrediction>.from(json.decode(str).map(
      (x) => AutoCompletePrediction.fromJson(x)
    ));

String autoCompletePredictionToJson(List<AutoCompletePrediction> data) =>
